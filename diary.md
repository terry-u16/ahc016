...
正解率の高いグラフから順番に選ぶようにした。思ったほど大きな効果はなかったが、相対28.5Bで18位。ついでに焼きなましの回数も1回から5回に増やして多数決を取るようにした。29.3Bで15位。ちなみにこのときymatsuxさんが41.2Bで単独トップに躍り出たので相対スコアがよく分からなくなっている。
